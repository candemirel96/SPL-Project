...
from fielddistribute import FieldDistribute
...
class Deck:
    ...
    def load_piles(self, display_size):
        ...
        tableau1 = FieldDistribute([self.cards[0]], start_x, start_y, self.card_size)
        tableau2 = FieldDistribute(self.cards[1:3], start_x + self.card_size[0] + pile_spacing, start_y, self.card_size)
        tableau3 = FieldDistribute(self.cards[3:6], start_x + self.card_size[0] * 2 + pile_spacing * 2, start_y, self.card_size)
        tableau4 = FieldDistribute(self.cards[6:10], start_x + self.card_size[0] * 3 + pile_spacing * 3, start_y, self.card_size)
        tableau5 = FieldDistribute(self.cards[10:15], start_x + self.card_size[0] * 4 + pile_spacing * 4, start_y, self.card_size)
        tableau6 = FieldDistribute(self.cards[15:21], start_x + self.card_size[0] * 5 + pile_spacing * 5, start_y, self.card_size)
        tableau7 = FieldDistribute(self.cards[21:28], start_x + self.card_size[0] * 6 + pile_spacing * 6, start_y, self.card_size)

        stock = FieldDistribute(self.cards[28:], start_x, pile_spacing, self.card_size, pile_type="stock")
        waste = FieldDistribute([], start_x + self.card_size[0] + pile_spacing, pile_spacing, self.card_size, pile_type="waste")

        foundation1 = FieldDistribute([], foundation_start_x, pile_spacing, self.card_size, pile_type="foundation")
        foundation2 = FieldDistribute([], foundation_start_x + foundation_x_step, pile_spacing, self.card_size, pile_type="foundation")
        foundation3 = FieldDistribute([], foundation_start_x + foundation_x_step * 2, pile_spacing, self.card_size, pile_type="foundation")
        foundation4 = FieldDistribute([], foundation_start_x + foundation_x_step * 3, pile_spacing, self.card_size, pile_type="foundation")
