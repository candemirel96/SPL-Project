...
def PokerGame():
    ...
    class Deck(list):
        def __init__(self):
            ...
            [[self.append(poker(i, j)) for j in suits] for i in values]
    ...
    class PokerView(Tk):
        def __init__(self, *args, **kwargs):
            ...
            list_of_frames = [PokerGameSetup, PokerWinCondition]
            ...
            self.fresh = True
            self.show_frame(PokerGameSetup)
    ...
    class PokerGameSetup(Frame):
        ...
        def button_click(self, entry0, entry1, entry2, entry3, entry4, entry5, entry6, entry7, entry8, entry9, entrysc,
            ...
            game_event.set()
            controller.show_frame(PokerWinCondition)

        def shuffle_cards(self):
            random.shuffle(self.cards)

    class PokerWinCondition(Frame):
        def __init__(self, parent, controller):
            Frame.__init__(self, parent)
